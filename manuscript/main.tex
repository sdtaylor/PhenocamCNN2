...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%% optional
\supplementary{The following are available online at \linksupplementary{s1}, Figure S1:  Locations of all PhenoCam sites used in the study, Figures S2-S11: Example classification output from the VGG16 classifier, Table S1: Site information for PhenoCams used in this study, Tables S2-S3: Transition matrices for the hidden markove models.}
...
\funding{D.B. was supported by the USDA, CRIS:3050-11210-009-00D}
