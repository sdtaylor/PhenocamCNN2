...
% this ensures figures are placed within sections
...
\begin{figure}[!ht]
    \centering
    \includegraphics[width=0.95\textwidth]{figures/fig1_example_images.jpg}
...
\begin{figure}[!ht]
    \centering
    \includegraphics[width=0.95\textwidth]{figures/fig2_base_stats.pdf}
...
\begin{figure}[!ht]
    \centering
    \includegraphics[width=0.95\textwidth]{figures/fig3_hmm_stats.pdf}
...
\begin{figure}[!ht]
    \centering
    \includegraphics[width=0.95\textwidth]{figures/fig4-timeseries-arsmorris2-2020.pdf}
...
\begin{figure}[!ht]
    \centering
    \includegraphics[width=0.95\textwidth]{figures/fig5-timeseries-bouldinalfalfa-2018.pdf}
...
\begin{figure}[!ht]
    \centering
    \includegraphics[width=0.95\textwidth]{figures/fig6-timeseries-cafcookeastltar01-2018.pdf}
...
\begin{figure}[!ht]
    \centering
    \includegraphics[width=0.95\textwidth]{figures/fig7-timeseries-NEON.D06.KONA.DP1.00042-2017.pdf}
