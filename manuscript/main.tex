...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%% optional
\supplementary{The following are available online at \linksupplementary{s1}, Figure S1:  Locations of all PhenoCam sites used in the study, Figures S2-S3: Confusion matrices for the classification results, Figures S4-S13: Example classification output from the VGG16 classifier, Figures S14-S15: CNN Model comparison figures, Table S1: Site information for PhenoCams used in this study, Tables S2-S3: Transition matrices for the hidden markove models.}
